...
class Asset:
    ...
    withdrawal_taxes: List[TaxRate] = field(default_factory=list)
    ...
    def get_tax_rate(self, current_age: Age) -> Optional[TaxRate]:
        """Get the withdrawal tax rate for the current age, if any."""
        for tax_rate in self.withdrawal_taxes:
...
class AssetBuilder:
    ...
    def __init__(self, name: str):
        ...
        self._withdrawal_taxes: List[TaxRate] = []
    ...
    def with_withdrawal_tax(self, tax_rate: TaxRate) -> AssetBuilder:
        self._withdrawal_taxes.append(tax_rate)
        return self
    ...
    def build(self) -> Asset:
        return Asset(
            ...
            withdrawal_taxes=self._withdrawal_taxes,
        )
