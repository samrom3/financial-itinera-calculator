    ...
    def run(
        ...
        if net_cash_flow > 0:
            ...
            for asset in sorted_assets:
                ...
                tax_rate = (
                    new_asset.get_override_tax_rate(current_age) or active_tax_rate
                )
                if tax_rate:
        ...
        for i, income in enumerate(incomes):
            ...
            incomes[i] = replace(income, monthly_amount=income.monthly_amount + growth)
        ...
        for i, expense in enumerate(expenses):
            rate = expense.growth_strategy.get_monthly_growth_rate(current_age.month)
