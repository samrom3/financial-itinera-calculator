...
def test_simulation_turn_data():
    ...
    assert turn.total_current_assets == 10_000
    assert turn.total_next_assets == 12_000
    assert turn.current_income_breakdown.total == 5000
...
def test_multi_asset_scenario():
    ...
    assert turn.total_next_assets == asset_1_final + asset_2_final
